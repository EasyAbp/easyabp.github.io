...
| [NotificationService](https://github.com/EasyAbp/NotificationService) | An integrated user notification service Abp module, supporting email, SMS, PM, and more other methods. | [![NuGet](https://img.shields.io/nuget/v/EasyAbp.NotificationService.Domain.Shared.svg?style=flat-square&label=)](https://www.nuget.org/packages/EasyAbp.NotificationService.Domain.Shared) |
